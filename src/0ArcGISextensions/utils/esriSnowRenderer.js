  ...
  var SnowLayer = declare(null, {
    ...
    add: function () {
      ...
      for (var i = 0; i < this.snowNum; i++) {
        ...
        this.particle.scale.x = this.particle.scale.y = 0.5; // 图片大小
        this.scene.add(this.particle);
        this.particles.push(this.particle);
      }
      snowPanel.appendChild(this.renderer.domElement);
      this.view.container.appendChild(snowPanel);
