var THREESNOW = THREESNOW || {};
if (!self.Int32Array) (self.Int32Array = Array), (self.Float32Array = Array);
THREESNOW.Color = function (a) {
  a !== void 0 && this.setHex(a);
  return this;
};
THREESNOW.Color.prototype = {
  constructor: THREESNOW.Color,
  r: 1,
  g: 1,
  b: 1,
  copy: function (a) {
  ...
  clone: function () {
    return new THREESNOW.Color().setRGB(this.r, this.g, this.b);
  },
};
THREESNOW.Vector2 = function (a, b) {
  this.x = a || 0;
  this.y = b || 0;
};
THREESNOW.Vector2.prototype = {
  constructor: THREESNOW.Vector2,
  set: function (a, b) {
    this.x = a;
    this.y = b;
    return this;
  ...
  clone: function () {
    return new THREESNOW.Vector2(this.x, this.y);
  },
  add: function (a, b) {
    this.x = a.x + b.x;
    this.y = a.y + b.y;
...
THREESNOW.Vector3 = function (a, b, c) {
  this.x = a || 0;
  this.y = b || 0;
  this.z = c || 0;
};
THREESNOW.Vector3.prototype = {
  constructor: THREESNOW.Vector3,
  set: function (a, b, c) {
    this.x = a;
    this.y = b;
    this.z = c;
  ...
  clone: function () {
    return new THREESNOW.Vector3(this.x, this.y, this.z);
  },
  add: function (a, b) {
    this.x = a.x + b.x;
    this.y = a.y + b.y;
  ...
  distanceToSquared: function (a) {
    return new THREESNOW.Vector3().sub(this, a).lengthSq();
  },
...
THREESNOW.Vector4 = function (a, b, c, d) {
  this.x = a || 0;
  this.y = b || 0;
  this.z = c || 0;
  this.w = d !== void 0 ? d : 1;
};
THREESNOW.Vector4.prototype = {
  constructor: THREESNOW.Vector4,
  ...
  clone: function () {
    return new THREESNOW.Vector4(this.x, this.y, this.z, this.w);
  },
  add: function (a, b) {
    this.x = a.x + b.x;
    this.y = a.y + b.y;
...
THREESNOW.Ray = function (a, b) {
  ...
  this.origin = a || new THREESNOW.Vector3();
  this.direction = b || new THREESNOW.Vector3();
  ...
  var f = new THREESNOW.Vector3(),
    e = new THREESNOW.Vector3(),
    g = new THREESNOW.Vector3(),
    h = new THREESNOW.Vector3(),
    a = new THREESNOW.Vector3(),
    b = new THREESNOW.Vector3(),
    m = new THREESNOW.Vector3(),
    l = new THREESNOW.Vector3(),
    j = new THREESNOW.Vector3();
          ...
          if (
            ...
            d(j, f, e, g) &&
              ((i = {
                ...
                o.push(i));
          else if (i instanceof THREESNOW.Face4 && (d(j, f, e, h) || d(j, e, g, h)))
            (i = {
              distance: a.distanceTo(j),
              point: j.clone(),
              face: i,
  ...
  var i = new THREESNOW.Vector3(),
    n = new THREESNOW.Vector3(),
    o = new THREESNOW.Vector3(),
    p,
    k,
    s,
    K,
...
THREESNOW.Matrix3 = function () {
  this.m = [];
};
THREESNOW.Matrix3.prototype = {
  constructor: THREESNOW.Matrix3,
  transpose: function () {
    var a,
      b = this.m;
    a = b[1];
...
THREESNOW.Matrix4 = function (a, b, c, d, f, e, g, h, m, l, j, i, n, o, p, k) {
  this.set(
    a !== void 0 ? a : 1,
    b || 0,
    c || 0,
  ...
  this.flat = Array(16);
  this.m33 = new THREESNOW.Matrix3();
};
THREESNOW.Matrix4.prototype = {
  constructor: THREESNOW.Matrix4,
  ...
  lookAt: function (a, b, c) {
    var d = THREESNOW.Matrix4.__v1,
      f = THREESNOW.Matrix4.__v2,
      e = THREESNOW.Matrix4.__v3;
    e.sub(a, b).normalize();
    if (e.length() === 0) e.z = 1;
  ...
  getPosition: function () {
    return THREESNOW.Matrix4.__v1.set(this.n14, this.n24, this.n34);
  },
  getColumnX: function () {
    return THREESNOW.Matrix4.__v1.set(this.n11, this.n21, this.n31);
  },
  getColumnY: function () {
    return THREESNOW.Matrix4.__v1.set(this.n12, this.n22, this.n32);
  },
  getColumnZ: function () {
    return THREESNOW.Matrix4.__v1.set(this.n13, this.n23, this.n33);
  },
  ...
  compose: function (a, b, c) {
    var d = THREESNOW.Matrix4.__m1,
      f = THREESNOW.Matrix4.__m2;
    d.identity();
  ...
  decompose: function (a, b, c) {
    ...
    a = a instanceof THREESNOW.Vector3 ? a : new THREESNOW.Vector3();
    b = b instanceof THREESNOW.Quaternion ? b : new THREESNOW.Quaternion();
    c = c instanceof THREESNOW.Vector3 ? c : new THREESNOW.Vector3();
    c.x = d.length();
    c.y = f.length();
    c.z = e.length();
    a.x = this.n14;
...
THREESNOW.Matrix4.makeInvert3x3 = function (a) {
  var b = a.m33,
    c = b.m,
  ...
  a === 0 &&
    console.error('THREESNOW.Matrix4.makeInvert3x3: Matrix not invertible.');
  a = 1 / a;
  c[0] = a * d;
  c[1] = a * f;
  c[2] = a * e;
...
THREESNOW.Matrix4.makeFrustum = function (a, b, c, d, f, e) {
  var g;
  g = new THREESNOW.Matrix4();
  g.n11 = (2 * f) / (b - a);
  g.n12 = 0;
  g.n13 = (b + a) / (b - a);
  g.n14 = 0;
...
THREESNOW.Matrix4.makePerspective = function (a, b, c, d) {
  var f,
    a = c * Math.tan((a * Math.PI) / 360);
  f = -a;
  return THREESNOW.Matrix4.makeFrustum(f * b, a * b, f, a, c, d);
};
THREESNOW.Matrix4.makeOrtho = function (a, b, c, d, f, e) {
  var g, h, m, l;
  g = new THREESNOW.Matrix4();
  h = b - a;
  m = c - d;
...
THREESNOW.Matrix4.__v1 = new THREESNOW.Vector3();
THREESNOW.Matrix4.__v2 = new THREESNOW.Vector3();
THREESNOW.Matrix4.__v3 = new THREESNOW.Vector3();
THREESNOW.Matrix4.__m1 = new THREESNOW.Matrix4();
THREESNOW.Matrix4.__m2 = new THREESNOW.Matrix4();
THREESNOW.Object3D = function () {
  this.name = '';
  this.id = THREESNOW.Object3DCount++;
  this.parent = void 0;
  this.children = [];
  this.up = new THREESNOW.Vector3(0, 1, 0);
  this.position = new THREESNOW.Vector3();
  this.rotation = new THREESNOW.Vector3();
  this.eulerOrder = 'XYZ';
  this.scale = new THREESNOW.Vector3(1, 1, 1);
  this.flipSided = this.doubleSided = this.dynamic = !1;
  this.renderDepth = null;
  this.rotationAutoUpdate = !0;
  this.matrix = new THREESNOW.Matrix4();
  this.matrixWorld = new THREESNOW.Matrix4();
  this.matrixRotationWorld = new THREESNOW.Matrix4();
  this.matrixWorldNeedsUpdate = this.matrixAutoUpdate = !0;
  this.quaternion = new THREESNOW.Quaternion();
  ...
  this._vector = new THREESNOW.Vector3();
};
THREESNOW.Object3D.prototype = {
  constructor: THREESNOW.Object3D,
  ...
  add: function (a) {
    if (this.children.indexOf(a) === -1) {
      ...
      b !== void 0 && b instanceof THREESNOW.Scene && b.addObject(a);
    }
  },
  remove: function (a) {
    ...
    if (b !== -1) {
      ...
      b !== void 0 && b instanceof THREESNOW.Scene && b.removeObject(a);
    }
  },
...
THREESNOW.Object3DCount = 0;
THREESNOW.Projector = function () {
  function a() {
    var a = (g[e] = g[e] || new THREESNOW.RenderableObject());
    e++;
    return a;
  }
  function b() {
    var a = (l[m] = l[m] || new THREESNOW.RenderableVertex());
    m++;
    return a;
  }
  function c(a, b) {
  ...
  var f,
    ...
    F = new THREESNOW.Vector3(),
    z = new THREESNOW.Vector4(),
    D = new THREESNOW.Matrix4(),
    u = new THREESNOW.Matrix4(),
    r = [
      new THREESNOW.Vector4(),
      new THREESNOW.Vector4(),
      new THREESNOW.Vector4(),
      new THREESNOW.Vector4(),
      new THREESNOW.Vector4(),
    ...
    E = new THREESNOW.Vector4(),
    N = new THREESNOW.Vector4();
  ...
  this.pickingRay = function (a, b) {
    var c;
    a.z = -1;
    c = new THREESNOW.Vector3(a.x, a.y, 1);
    this.unprojectVector(a, b);
    this.unprojectVector(c, b);
    c.subSelf(a).normalize();
    return new THREESNOW.Ray(a, c);
  };
  this.projectGraph = function (b, d) {
    ...
    var g = function (b) {
      if (b.visible !== !1) {
        var c;
        if ((c = b instanceof THREESNOW.Mesh || b instanceof THREESNOW.Line))
        ...
        c
          ? (D.multiplyVector3(F.copy(b.position)),
            ...
            (f.z = F.z),
            w.objects.push(f))
          : b instanceof THREESNOW.Sprite || b instanceof THREESNOW.Particle
            ? (D.multiplyVector3(F.copy(b.position)),
              (f = a()),
              (f.object = b),
              (f.z = F.z),
              w.sprites.push(f))
            : b instanceof THREESNOW.Light && w.lights.push(b);
        c = 0;
    ...
    for (F = w.objects.length; a < F; a++)
      if (
        ...
        for (L = M.length; S < L; S++) {
          B = M[S];
          if (B instanceof THREESNOW.Face3)
            if (
              ((v = l[B.a]),
                (R = l[B.b]),
                (P = l[B.c]),
              ...
              (V = n[i] = n[i] || new THREESNOW.RenderableFace3()),
                i++ ,
                (j = V),
                j.v1.copy(v),
                j.v2.copy(R),
          ...
          else if (B instanceof THREESNOW.Face4)
            if (
              ((v = l[B.a]),
                (R = l[B.b]),
                (P = l[B.c]),
              ...
              (fa = p[o] = p[o] || new THREESNOW.RenderableFace4()),
                o++ ,
                (j = fa),
                j.v1.copy(v),
                j.v2.copy(R),
      ...
      } else if (J instanceof THREESNOW.Line) {
        u.multiply(D, t);
        ...
        for (B = S.length; L < B; L++)
          if (
            ...
            E.multiplyScalar(1 / E.w),
              ...
              (J = K[s] = K[s] || new THREESNOW.RenderableLine()),
              s++ ,
              (k = J),
    ...
    for (F = w.sprites.length; a < F; a++)
      if (
        ((J = w.sprites[a].object),
          (t = J.matrixWorld),
          J instanceof THREESNOW.Particle &&
          (z.set(t.n14, t.n24, t.n34, 1),
            D.multiplyVector4(z),
            (z.z /= z.w),
            z.z > 0 && z.z < 1))
      )
        (g = O[Q] = O[Q] || new THREESNOW.RenderableParticle()),
          Q++ ,
          (C = g),
          (C.x = z.x / z.w),
          (C.y = z.y / z.w),
...
THREESNOW.Quaternion = function (a, b, c, d) {
  this.set(a || 0, b || 0, c || 0, d !== void 0 ? d : 1);
};
THREESNOW.Quaternion.prototype = {
  constructor: THREESNOW.Quaternion,
  set: function (a, b, c, d) {
    this.x = a;
    this.y = b;
    this.z = c;
...
THREESNOW.Quaternion.slerp = function (a, b, c, d) {
...
THREESNOW.Vertex = function (a) {
  this.position = a || new THREESNOW.Vector3();
};
THREESNOW.Face3 = function (a, b, c, d, f, e) {
  this.a = a;
  this.b = b;
  this.c = c;
  this.normal = d instanceof THREESNOW.Vector3 ? d : new THREESNOW.Vector3();
  this.vertexNormals = d instanceof Array ? d : [];
  this.color = f instanceof THREESNOW.Color ? f : new THREESNOW.Color();
  this.vertexColors = f instanceof Array ? f : [];
  this.vertexTangents = [];
  this.materialIndex = e;
  this.centroid = new THREESNOW.Vector3();
};
THREESNOW.Face4 = function (a, b, c, d, f, e, g) {
  this.a = a;
  this.b = b;
  this.c = c;
  this.d = d;
  this.normal = f instanceof THREESNOW.Vector3 ? f : new THREESNOW.Vector3();
  this.vertexNormals = f instanceof Array ? f : [];
  this.color = e instanceof THREESNOW.Color ? e : new THREESNOW.Color();
  this.vertexColors = e instanceof Array ? e : [];
  this.vertexTangents = [];
  this.materialIndex = g;
  this.centroid = new THREESNOW.Vector3();
};
THREESNOW.UV = function (a, b) {
  this.u = a || 0;
  this.v = b || 0;
};
THREESNOW.UV.prototype = {
  constructor: THREESNOW.UV,
  set: function (a, b) {
    this.u = a;
    this.v = b;
    return this;
  ...
  clone: function () {
    return new THREESNOW.UV(this.u, this.v);
  },
};
THREESNOW.Geometry = function () {
  this.id = THREESNOW.GeometryCount++;
  this.vertices = [];
  this.colors = [];
  this.materials = [];
  this.faces = [];
...
THREESNOW.Geometry.prototype = {
  constructor: THREESNOW.Geometry,
  applyMatrix: function (a) {
    var b = new THREESNOW.Matrix4();
    b.extractRotation(a, new THREESNOW.Vector3(1, 1, 1));
  ...
  computeVertexNormals: function () {
    ...
    if (this.__tmpVertices === void 0) {
      ...
      a = 0;
      for (b = this.vertices.length; a < b; a++) d[a] = new THREESNOW.Vector3();
      a = 0;
      for (b = this.faces.length; a < b; a++)
        if (((c = this.faces[a]), c instanceof THREESNOW.Face3))
          c.vertexNormals = [
            new THREESNOW.Vector3(),
            new THREESNOW.Vector3(),
            new THREESNOW.Vector3(),
          ];
        else if (c instanceof THREESNOW.Face4)
          c.vertexNormals = [
            new THREESNOW.Vector3(),
            new THREESNOW.Vector3(),
            new THREESNOW.Vector3(),
  ...
  computeTangents: function () {
    ...
    var b,
      ...
      E = new THREESNOW.Vector3(),
      N = new THREESNOW.Vector3(),
      W = new THREESNOW.Vector3(),
      da = new THREESNOW.Vector3(),
      G = new THREESNOW.Vector3();
    b = 0;
    for (c = this.vertices.length; b < c; b++)
      (u[b] = new THREESNOW.Vector3()), (r[b] = new THREESNOW.Vector3());
    b = 0;
    for (c = this.faces.length; b < c; b++)
      (e = this.faces[b]),
        (g = this.faceVertexUvs[0][b]),
        e instanceof THREESNOW.Face3
          ? a(this, e.a, e.b, e.c, 0, 1, 2)
          : e instanceof THREESNOW.Face4 &&
    ...
    for (c = this.faces.length; b < c; b++) {
      ...
      for (d = 0; d < e.vertexNormals.length; d++)
        G.copy(e.vertexNormals[d]),
          ...
          (f = da.dot(r[f])),
          (f = f < 0 ? -1 : 1),
          (e.vertexTangents[d] = new THREESNOW.Vector4(W.x, W.y, W.z, f));
    }
    this.hasTangents = !0;
  },
  ...
  mergeVertices: function () {
    ...
    for (g = this.faces.length; e < g; e++)
      if (((a = this.faces[e]), a instanceof THREESNOW.Face3))
        (a.a = c[a.a]), (a.b = c[a.b]), (a.c = c[a.c]);
      else if (a instanceof THREESNOW.Face4)
        (a.a = c[a.a]), (a.b = c[a.b]), (a.c = c[a.c]), (a.d = c[a.d]);
    this.vertices = b;
  },
};
THREESNOW.GeometryCount = 0;
THREESNOW.Camera = function () {
  if (arguments.length)
    return (
      console.warn(
        'DEPRECATED: Camera() is now PerspectiveCamera() or OrthographicCamera().',
      ),
      new THREESNOW.PerspectiveCamera(
        arguments[0],
        arguments[1],
        arguments[2],
        arguments[3],
  ...
  THREESNOW.Object3D.call(this);
  this.matrixWorldInverse = new THREESNOW.Matrix4();
  this.projectionMatrix = new THREESNOW.Matrix4();
  this.projectionMatrixInverse = new THREESNOW.Matrix4();
};
THREESNOW.Camera.prototype = new THREESNOW.Object3D();
THREESNOW.Camera.prototype.constructor = THREESNOW.Camera;
THREESNOW.Camera.prototype.lookAt = function (a) {
  this.matrix.lookAt(this.position, a, this.up);
  this.rotationAutoUpdate && this.rotation.setRotationFromMatrix(this.matrix);
};
THREESNOW.OrthographicCamera = function (a, b, c, d, f, e) {
  THREESNOW.Camera.call(this);
  this.left = a;
  this.right = b;
  this.top = c;
  this.bottom = d;
...
THREESNOW.OrthographicCamera.prototype = new THREESNOW.Camera();
THREESNOW.OrthographicCamera.prototype.constructor = THREESNOW.OrthographicCamera;
THREESNOW.OrthographicCamera.prototype.updateProjectionMatrix = function () {
  this.projectionMatrix = THREESNOW.Matrix4.makeOrtho(
    this.left,
    this.right,
    this.top,
    this.bottom,
...
THREESNOW.PerspectiveCamera = function (a, b, c, d) {
  THREESNOW.Camera.call(this);
...
THREESNOW.PerspectiveCamera.prototype = new THREESNOW.Camera();
THREESNOW.PerspectiveCamera.prototype.constructor = THREESNOW.PerspectiveCamera;
THREESNOW.PerspectiveCamera.prototype.setLens = function (a, b) {
  this.fov = 2 * Math.atan((b !== void 0 ? b : 43.25) / (a * 2));
  this.fov *= 180 / Math.PI;
  this.updateProjectionMatrix();
};
THREESNOW.PerspectiveCamera.prototype.setViewOffset = function (a, b, c, d, f, e) {
  this.fullWidth = a;
  this.fullHeight = b;
  this.x = c;
  this.y = d;
...
THREESNOW.PerspectiveCamera.prototype.updateProjectionMatrix = function () {
  if (this.fullWidth) {
    var a = this.fullWidth / this.fullHeight,
      ...
      a = Math.abs(a * b - d),
      c = Math.abs(b - c);
    this.projectionMatrix = THREESNOW.Matrix4.makeFrustum(
    ...
    this.projectionMatrix = THREESNOW.Matrix4.makePerspective(
      this.fov,
      this.aspect,
      this.near,
      this.far,
...
THREESNOW.Light = function (a) {
  THREESNOW.Object3D.call(this);
  this.color = new THREESNOW.Color(a);
};
THREESNOW.Light.prototype = new THREESNOW.Object3D();
THREESNOW.Light.prototype.constructor = THREESNOW.Light;
THREESNOW.Light.prototype.supr = THREESNOW.Object3D.prototype;
THREESNOW.AmbientLight = function (a) {
  THREESNOW.Light.call(this, a);
};
THREESNOW.AmbientLight.prototype = new THREESNOW.Light();
THREESNOW.AmbientLight.prototype.constructor = THREESNOW.AmbientLight;
THREESNOW.DirectionalLight = function (a, b, c) {
  THREESNOW.Light.call(this, a);
  this.position = new THREESNOW.Vector3(0, 1, 0);
  this.intensity = b !== void 0 ? b : 1;
  this.distance = c !== void 0 ? c : 0;
};
THREESNOW.DirectionalLight.prototype = new THREESNOW.Light();
THREESNOW.DirectionalLight.prototype.constructor = THREESNOW.DirectionalLight;
THREESNOW.PointLight = function (a, b, c) {
  THREESNOW.Light.call(this, a);
  this.position = new THREESNOW.Vector3(0, 0, 0);
  this.intensity = b !== void 0 ? b : 1;
  this.distance = c !== void 0 ? c : 0;
};
THREESNOW.PointLight.prototype = new THREESNOW.Light();
THREESNOW.PointLight.prototype.constructor = THREESNOW.PointLight;
THREESNOW.Material = function (a) {
  this.name = '';
  this.id = THREESNOW.MaterialCount++;
  a = a || {};
  this.opacity = a.opacity !== void 0 ? a.opacity : 1;
  this.transparent = a.transparent !== void 0 ? a.transparent : !1;
  this.blending = a.blending !== void 0 ? a.blending : THREESNOW.NormalBlending;
...
THREESNOW.MaterialCount = 0;
THREESNOW.NoShading = 0;
THREESNOW.FlatShading = 1;
THREESNOW.SmoothShading = 2;
THREESNOW.NoColors = 0;
THREESNOW.FaceColors = 1;
THREESNOW.VertexColors = 2;
THREESNOW.NormalBlending = 0;
THREESNOW.AdditiveBlending = 1;
THREESNOW.SubtractiveBlending = 2;
THREESNOW.MultiplyBlending = 3;
THREESNOW.AdditiveAlphaBlending = 4;
THREESNOW.LineBasicMaterial = function (a) {
  THREESNOW.Material.call(this, a);
  a = a || {};
  this.color =
    a.color !== void 0 ? new THREESNOW.Color(a.color) : new THREESNOW.Color(16777215);
...
THREESNOW.LineBasicMaterial.prototype = new THREESNOW.Material();
THREESNOW.LineBasicMaterial.prototype.constructor = THREESNOW.LineBasicMaterial;
THREESNOW.MeshBasicMaterial = function (a) {
  THREESNOW.Material.call(this, a);
  a = a || {};
  this.color =
    a.color !== void 0 ? new THREESNOW.Color(a.color) : new THREESNOW.Color(16777215);
  ...
  this.combine = a.combine !== void 0 ? a.combine : THREESNOW.MultiplyOperation;
  this.reflectivity = a.reflectivity !== void 0 ? a.reflectivity : 1;
  this.refractionRatio =
    a.refractionRatio !== void 0 ? a.refractionRatio : 0.98;
  this.fog = a.fog !== void 0 ? a.fog : !0;
  this.shading = a.shading !== void 0 ? a.shading : THREESNOW.SmoothShading;
...
THREESNOW.MeshBasicMaterial.prototype = new THREESNOW.Material();
THREESNOW.MeshBasicMaterial.prototype.constructor = THREESNOW.MeshBasicMaterial;
THREESNOW.MeshLambertMaterial = function (a) {
  THREESNOW.Material.call(this, a);
  a = a || {};
  this.color =
    a.color !== void 0 ? new THREESNOW.Color(a.color) : new THREESNOW.Color(16777215);
  this.ambient =
    a.ambient !== void 0 ? new THREESNOW.Color(a.ambient) : new THREESNOW.Color(328965);
  this.map = a.map !== void 0 ? a.map : null;
  this.lightMap = a.lightMap !== void 0 ? a.lightMap : null;
  this.envMap = a.envMap !== void 0 ? a.envMap : null;
  this.combine = a.combine !== void 0 ? a.combine : THREESNOW.MultiplyOperation;
...
THREESNOW.MeshLambertMaterial.prototype = new THREESNOW.Material();
THREESNOW.MeshLambertMaterial.prototype.constructor = THREESNOW.MeshLambertMaterial;
THREESNOW.MeshPhongMaterial = function (a) {
  THREESNOW.Material.call(this, a);
  a = a || {};
  this.color =
    a.color !== void 0 ? new THREESNOW.Color(a.color) : new THREESNOW.Color(16777215);
  ...
  this.specular =
    a.specular !== void 0
      ? new THREESNOW.Color(a.specular)
      : new THREESNOW.Color(1118481);
...
THREESNOW.MeshPhongMaterial.prototype = new THREESNOW.Material();
THREESNOW.MeshPhongMaterial.prototype.constructor = THREESNOW.MeshPhongMaterial;
THREESNOW.MeshDepthMaterial = function (a) {
  THREESNOW.Material.call(this, a);
  a = a || {};
  this.shading = a.shading !== void 0 ? a.shading : THREESNOW.SmoothShading;
  this.wireframe = a.wireframe !== void 0 ? a.wireframe : !1;
...
THREESNOW.MeshDepthMaterial.prototype = new THREESNOW.Material();
THREESNOW.MeshDepthMaterial.prototype.constructor = THREESNOW.MeshDepthMaterial;
THREESNOW.MeshNormalMaterial = function (a) {
  THREESNOW.Material.call(this, a);
  a = a || {};
  this.shading = a.shading ? a.shading : THREESNOW.FlatShading;
  this.wireframe = a.wireframe ? a.wireframe : !1;
  this.wireframeLinewidth = a.wireframeLinewidth ? a.wireframeLinewidth : 1;
};
THREESNOW.MeshNormalMaterial.prototype = new THREESNOW.Material();
THREESNOW.MeshNormalMaterial.prototype.constructor = THREESNOW.MeshNormalMaterial;
THREESNOW.MeshFaceMaterial = function () { };
THREESNOW.ParticleBasicMaterial = function (a) {
  THREESNOW.Material.call(this, a);
  a = a || {};
  this.color =
    a.color !== void 0 ? new THREESNOW.Color(a.color) : new THREESNOW.Color(16777215);
...
THREESNOW.ParticleBasicMaterial.prototype = new THREESNOW.Material();
THREESNOW.ParticleBasicMaterial.prototype.constructor = THREESNOW.ParticleBasicMaterial;
THREESNOW.ParticleCanvasMaterial = function (a) {
  THREESNOW.Material.call(this, a);
  a = a || {};
  this.color =
    a.color !== void 0 ? new THREESNOW.Color(a.color) : new THREESNOW.Color(16777215);
...
THREESNOW.ParticleCanvasMaterial.prototype = new THREESNOW.Material();
THREESNOW.ParticleCanvasMaterial.prototype.constructor =
  THREESNOW.ParticleCanvasMaterial;
THREESNOW.Texture = function (a, b, c, d, f, e) {
  this.id = THREESNOW.TextureCount++;
  this.image = a;
  this.mapping = b !== void 0 ? b : new THREESNOW.UVMapping();
  this.wrapS = c !== void 0 ? c : THREESNOW.ClampToEdgeWrapping;
  this.wrapT = d !== void 0 ? d : THREESNOW.ClampToEdgeWrapping;
  this.magFilter = f !== void 0 ? f : THREESNOW.LinearFilter;
  this.minFilter = e !== void 0 ? e : THREESNOW.LinearMipMapLinearFilter;
  this.offset = new THREESNOW.Vector2(0, 0);
  this.repeat = new THREESNOW.Vector2(1, 1);
  this.needsUpdate = !1;
  this.onUpdate = null;
};
THREESNOW.Texture.prototype = {
  constructor: THREESNOW.Texture,
  clone: function () {
    var a = new THREESNOW.Texture(
      this.image,
      this.mapping,
      this.wrapS,
      this.wrapT,
...
THREESNOW.TextureCount = 0;
THREESNOW.MultiplyOperation = 0;
THREESNOW.MixOperation = 1;
THREESNOW.CubeReflectionMapping = function () { };
THREESNOW.CubeRefractionMapping = function () { };
THREESNOW.LatitudeReflectionMapping = function () { };
THREESNOW.LatitudeRefractionMapping = function () { };
THREESNOW.SphericalReflectionMapping = function () { };
THREESNOW.SphericalRefractionMapping = function () { };
THREESNOW.UVMapping = function () { };
THREESNOW.RepeatWrapping = 0;
THREESNOW.ClampToEdgeWrapping = 1;
THREESNOW.MirroredRepeatWrapping = 2;
THREESNOW.NearestFilter = 3;
THREESNOW.NearestMipMapNearestFilter = 4;
THREESNOW.NearestMipMapLinearFilter = 5;
THREESNOW.LinearFilter = 6;
THREESNOW.LinearMipMapNearestFilter = 7;
THREESNOW.LinearMipMapLinearFilter = 8;
THREESNOW.ByteType = 9;
THREESNOW.UnsignedByteType = 10;
THREESNOW.ShortType = 11;
THREESNOW.UnsignedShortType = 12;
THREESNOW.IntType = 13;
THREESNOW.UnsignedIntType = 14;
THREESNOW.FloatType = 15;
THREESNOW.AlphaFormat = 16;
THREESNOW.RGBFormat = 17;
THREESNOW.RGBAFormat = 18;
THREESNOW.LuminanceFormat = 19;
THREESNOW.LuminanceAlphaFormat = 20;
THREESNOW.Particle = function (a) {
  THREESNOW.Object3D.call(this);
  this.material = a;
};
THREESNOW.Particle.prototype = new THREESNOW.Object3D();
THREESNOW.Particle.prototype.constructor = THREESNOW.Particle;
THREESNOW.Line = function (a, b, c) {
  THREESNOW.Object3D.call(this);
  this.geometry = a;
  this.material = b;
  this.type = c !== void 0 ? c : THREESNOW.LineStrip;
  this.geometry &&
    (this.geometry.boundingSphere || this.geometry.computeBoundingSphere());
};
THREESNOW.LineStrip = 0;
THREESNOW.LinePieces = 1;
THREESNOW.Line.prototype = new THREESNOW.Object3D();
THREESNOW.Line.prototype.constructor = THREESNOW.Line;
THREESNOW.Mesh = function (a, b) {
  THREESNOW.Object3D.call(this);
  this.geometry = a;
  this.material = b;
...
THREESNOW.Mesh.prototype = new THREESNOW.Object3D();
THREESNOW.Mesh.prototype.constructor = THREESNOW.Mesh;
THREESNOW.Mesh.prototype.supr = THREESNOW.Object3D.prototype;
THREESNOW.Mesh.prototype.getMorphTargetIndexByName = function (a) {
  if (this.morphTargetDictionary[a] !== void 0)
    return this.morphTargetDictionary[a];
  console.log(
    'THREESNOW.Mesh.getMorphTargetIndexByName: morph target ' +
    a +
    ' does not exist. Returning 0.',
  );
  return 0;
};
THREESNOW.Bone = function (a) {
  THREESNOW.Object3D.call(this);
  this.skin = a;
  this.skinMatrix = new THREESNOW.Matrix4();
};
THREESNOW.Bone.prototype = new THREESNOW.Object3D();
THREESNOW.Bone.prototype.constructor = THREESNOW.Bone;
THREESNOW.Bone.prototype.supr = THREESNOW.Object3D.prototype;
THREESNOW.Bone.prototype.update = function (a, b) {
...
THREESNOW.Sprite = function (a) {
  THREESNOW.Object3D.call(this);
  this.color =
    a.color !== void 0 ? new THREESNOW.Color(a.color) : new THREESNOW.Color(16777215);
  this.map =
    a.map instanceof THREESNOW.Texture
      ? a.map
      : THREESNOW.ImageUtils.loadTexture(a.map);
  this.blending = a.blending !== void 0 ? a.blending : THREESNOW.NormalBlending;
  ...
  this.alignment =
    a.alignment instanceof THREESNOW.Vector2
      ? a.alignment
      : THREESNOW.SpriteAlignment.center;
  this.rotation3d = this.rotation;
  this.rotation = 0;
  this.opacity = 1;
  this.uvOffset = new THREESNOW.Vector2(0, 0);
  this.uvScale = new THREESNOW.Vector2(1, 1);
};
THREESNOW.Sprite.prototype = new THREESNOW.Object3D();
THREESNOW.Sprite.prototype.constructor = THREESNOW.Sprite;
THREESNOW.Sprite.prototype.updateMatrix = function () {
  this.matrix.setPosition(this.position);
...
THREESNOW.SpriteAlignment = {};
THREESNOW.SpriteAlignment.topLeft = new THREESNOW.Vector2(1, -1);
THREESNOW.SpriteAlignment.topCenter = new THREESNOW.Vector2(0, -1);
THREESNOW.SpriteAlignment.topRight = new THREESNOW.Vector2(-1, -1);
THREESNOW.SpriteAlignment.centerLeft = new THREESNOW.Vector2(1, 0);
THREESNOW.SpriteAlignment.center = new THREESNOW.Vector2(0, 0);
THREESNOW.SpriteAlignment.centerRight = new THREESNOW.Vector2(-1, 0);
THREESNOW.SpriteAlignment.bottomLeft = new THREESNOW.Vector2(1, 1);
THREESNOW.SpriteAlignment.bottomCenter = new THREESNOW.Vector2(0, 1);
THREESNOW.SpriteAlignment.bottomRight = new THREESNOW.Vector2(-1, 1);
THREESNOW.Scene = function () {
  THREESNOW.Object3D.call(this);
...
THREESNOW.Scene.prototype = new THREESNOW.Object3D();
THREESNOW.Scene.prototype.constructor = THREESNOW.Scene;
THREESNOW.Scene.prototype.addObject = function (a) {
  if (a instanceof THREESNOW.Light)
    this.lights.indexOf(a) === -1 && this.lights.push(a);
  else if (
    !(a instanceof THREESNOW.Camera || a instanceof THREESNOW.Bone) &&
...
THREESNOW.Scene.prototype.removeObject = function (a) {
  if (a instanceof THREESNOW.Light) {
    var b = this.lights.indexOf(a);
    b !== -1 && this.lights.splice(b, 1);
  } else
    a instanceof THREESNOW.Camera ||
...
THREESNOW.CanvasRenderer = function (a) {
  function b(a) {
  ...
  function c(a) {
    if (Q != a) {
      switch (a) {
        case THREESNOW.NormalBlending:
          k.globalCompositeOperation = 'source-over';
          break;
        case THREESNOW.AdditiveBlending:
          k.globalCompositeOperation = 'lighter';
          break;
        case THREESNOW.SubtractiveBlending:
  ...
  var e = this,
    ...
    E,
    N,
    W = new THREESNOW.RenderableVertex(),
    da = new THREESNOW.RenderableVertex(),
    G,
    H,
    I,
    Y,
    ...
    V,
    J,
    t = new THREESNOW.Color(),
    A = new THREESNOW.Color(),
    x = new THREESNOW.Color(),
    y = new THREESNOW.Color(),
    M = new THREESNOW.Color(),
    la = [],
    fa = [],
    ga,
    ha,
    ...
    Fa,
    Ga,
    ma = new THREESNOW.Rectangle(),
    Z = new THREESNOW.Rectangle(),
    X = new THREESNOW.Rectangle(),
    ya = !1,
    $ = new THREESNOW.Color(),
    ta = new THREESNOW.Color(),
    ua = new THREESNOW.Color(),
    T = new THREESNOW.Vector3(),
    qa,
    ra,
    za,
    ba,
  ...
  this.render = function (a, j) {
    function i(a) {
      ...
      for (c = a.length; b < c; b++)
        (d = a[b]),
          (e = d.color),
          d instanceof THREESNOW.AmbientLight
            ? (($.r += e.r), ($.g += e.g), ($.b += e.b))
            : d instanceof THREESNOW.DirectionalLight
              ? ((ta.r += e.r), (ta.g += e.g), (ta.b += e.b))
              : d instanceof THREESNOW.PointLight &&
    ...
    function n(a, b, c, d) {
      ...
      for (f = a.length; e < f; e++)
        (g = a[e]),
          (h = g.color),
          g instanceof THREESNOW.DirectionalLight
            ? ((k = g.matrixWorld.getPosition()),
              ...
              ((j *= g.intensity),
                ...
                (d.g += h.g * j),
                (d.b += h.b * j)))
            : g instanceof THREESNOW.PointLight &&
            ((k = g.matrixWorld.getPosition()),
    ...
    function s(a, e, g) {
      ...
      c(g.blending);
      var h, j, i, m, q, n;
      if (g instanceof THREESNOW.ParticleBasicMaterial) {
        if (g.map)
          (m = g.map.image),
            (q = m.width >> 1),
            (n = m.height >> 1),
        ...
        g instanceof THREESNOW.ParticleCanvasMaterial &&
          ((h = e.scale.x * o),
            (j = e.scale.y * p),
            X.set(a.x - h, a.y - j, a.x + h, a.y + j),
            ma.intersects(X) &&
    ...
    function w(a, e, f, g) {
      ...
      k.closePath();
      if (g instanceof THREESNOW.LineBasicMaterial) {
        a = g.linewidth;
    ...
    function C(a, d, f, g, h, k, i, q) {
      ...
      K(G, H, I, Y, L, B);
      if (q instanceof THREESNOW.MeshBasicMaterial)
        if (q.map)
          q.map.mapping instanceof THREESNOW.UVMapping &&
            ((aa = i.uvs[0]),
              Aa(
                G,
                H,
          ...
          if (q.envMap.mapping instanceof THREESNOW.SphericalReflectionMapping)
          ...
          q.wireframe
            ...
            : ia(q.color);
      else if (q instanceof THREESNOW.MeshLambertMaterial)
        q.map &&
          !q.wireframe &&
          (q.map.mapping instanceof THREESNOW.UVMapping &&
            ((aa = i.uvs[0]),
            ...
            c(THREESNOW.SubtractiveBlending)),
          ya
            ? !q.wireframe &&
              q.shading == THREESNOW.SmoothShading &&
            ...
            : q.wireframe
              ...
              : ia(q.color);
      else if (q instanceof THREESNOW.MeshDepthMaterial)
        (ga = j.near),
          (ha = j.far),
          ...
          (ea = wa(A, x, y, M)),
          oa(G, H, I, Y, L, B, 0, 0, 1, 0, 0, 1, ea);
      else if (q instanceof THREESNOW.MeshNormalMaterial)
    ...
    function Q(a, d, f, g, h, k, i, q, o) {
      ...
      if (q.map || q.envMap)
        ...
        ((G = a.positionScreen.x),
          ...
          q instanceof THREESNOW.MeshBasicMaterial)
      )
        O(G, H, I, Y, L, B, S, v),
          q.wireframe
            ? ja(
    ...
    function Aa(a, b, c, d, e, g, h, i, j, m, o, n, l) {
      if (l.image.width != 0) {
        if (l.needsUpdate == !0 || la[l.id] == void 0) {
          var p = l.wrapS == THREESNOW.RepeatWrapping,
            r = l.wrapT == THREESNOW.RepeatWrapping;
    ...
    for (Ha = h.length; xa < Ha; xa++)
      if (
        ((U = h[xa]),
          (ca = U.material),
          (ca = ca instanceof THREESNOW.MeshFaceMaterial ? U.faceMaterial : ca),
          !(ca == null || ca.opacity == 0))
      ) {
        X.empty();
        if (U instanceof THREESNOW.RenderableParticle)
          (u = U), (u.x *= o), (u.y *= p), s(u, U, ca, a);
        else if (U instanceof THREESNOW.RenderableLine)
          (u = U.v1),
            (r = U.v2),
        ...
        else if (U instanceof THREESNOW.RenderableFace3)
          (u = U.v1),
            (r = U.v2),
            (E = U.v3),
            (u.positionScreen.x *= o),
        ...
        else if (U instanceof THREESNOW.RenderableFace4)
          (u = U.v1),
            (r = U.v2),
            (E = U.v3),
            (N = U.v4),
...
THREESNOW.RenderableVertex = function () {
  this.positionWorld = new THREESNOW.Vector3();
  this.positionScreen = new THREESNOW.Vector4();
  this.visible = !0;
};
THREESNOW.RenderableVertex.prototype.copy = function (a) {
  this.positionWorld.copy(a.positionWorld);
  this.positionScreen.copy(a.positionScreen);
};
THREESNOW.RenderableFace3 = function () {
  this.v1 = new THREESNOW.RenderableVertex();
  this.v2 = new THREESNOW.RenderableVertex();
  this.v3 = new THREESNOW.RenderableVertex();
  this.centroidWorld = new THREESNOW.Vector3();
  this.centroidScreen = new THREESNOW.Vector3();
  this.normalWorld = new THREESNOW.Vector3();
...
THREESNOW.RenderableFace4 = function () {
  this.v1 = new THREESNOW.RenderableVertex();
  this.v2 = new THREESNOW.RenderableVertex();
  this.v3 = new THREESNOW.RenderableVertex();
  this.v4 = new THREESNOW.RenderableVertex();
  this.centroidWorld = new THREESNOW.Vector3();
  this.centroidScreen = new THREESNOW.Vector3();
  this.normalWorld = new THREESNOW.Vector3();
  this.vertexNormalsWorld = [
...
THREESNOW.RenderableObject = function () {
  this.z = this.object = null;
};
THREESNOW.RenderableParticle = function () {
  this.rotation = this.z = this.y = this.x = null;
  this.scale = new THREESNOW.Vector2();
  this.material = null;
};
THREESNOW.RenderableLine = function () {
  this.z = null;
  this.v1 = new THREESNOW.RenderableVertex();
  this.v2 = new THREESNOW.RenderableVertex();
  this.material = null;
...
(Particle3D = function (t) {
  THREESNOW.Particle.call(this, t),
    (this.velocity = new THREESNOW.Vector3(0, -2, 0)),
    this.velocity.rotateX(randomRange(-45, 45)),
    this.velocity.rotateY(randomRange(0, 360)),
    (this.gravity = new THREESNOW.Vector3(0, 0, 0)),
    (this.drag = 1);
}),
  (Particle3D.prototype = new THREESNOW.Particle()),
...
(THREESNOW.Vector3.prototype.rotateY = function (t) {
  (cosRY = Math.cos(t * TO_RADIANS)), (sinRY = Math.sin(t * TO_RADIANS));
  var i = this.z,
    o = this.x;
  (this.x = o * cosRY + i * sinRY), (this.z = o * -sinRY + i * cosRY);
}),
  (THREESNOW.Vector3.prototype.rotateX = function (t) {
    (cosRY = Math.cos(t * TO_RADIANS)), (sinRY = Math.sin(t * TO_RADIANS));
    var i = this.z,
      o = this.y;
    (this.y = o * cosRY + i * sinRY), (this.z = o * -sinRY + i * cosRY);
  }),
  (THREESNOW.Vector3.prototype.rotateZ = function (t) {
    (cosRY = Math.cos(t * TO_RADIANS)), (sinRY = Math.sin(t * TO_RADIANS));
    var i = this.x,
      o = this.y;
...
define([
  ...
  // Constants
  var THREE = window.THREESNOW;

  var WeatherEffects = declare(null, {
    constructor: function (view, options) {
      ...
      this.particles = [];
      this.particleImageSrc = 'http://10.201.37.225:8080/smiapi/arcgis/shroad/images/snowflake.png' || './images/snowflake232.png';
    ...
    add: function (weather) {
      ...
      this._createWeatherEffect();
    },
    remove: function () {
      //清空雪效果
      var snowContainers = document.getElementsByClassName('snowContainer');
      if (snowContainers.length > 0) {
        for(var i=0;i<snowContainers.length;i++) {
          this.view.container.removeChild(snowContainers[i]);
        }
      }
      //清空雨效果
      if (this.view.container.getElementsByClassName('rainContainer').length > 0) {
        this.view.container.removeChild(this.view.container.getElementsByClassName('rainContainer')[0]);
      }
      this.rainTimer && cancelAnimationFrame(this.rainTimer);
    ...
    _createWeatherEffect: function () {
      switch (this.realTimeWeather) {
        case "晴":
          this._createSunnyEffect();
          break;
        case "多云":
          this._createSunnyEffect();
          break;
        ...
        case "雨夹雪":
          ...
          this._createSnowParticles(5000, 0.3);
            break;
        case "雪":
          this._createSnowContainer();
          this._createSnowParticles(2000, 0.2);
          break;
        case "小雪":
          this._createSnowContainer();
          this._createSnowParticles(2000, 0.2);
        ...
        case "大雪":
          this._createSnowContainer();
          this._createSnowParticles(15000, 0.4);
          break;
      }
    },
    _createSunnyEffect: function () {
      //设置SceneView中的环境光: 白天
      this.view.environment = {
        lighting: {
          directShadows: false,
          date: new Date("Wed Jul 01 2020 12:00:00 GMT+0000")
        }
      }
    },
    _initRainEffect: function () {
      this._createRainCanvas();
      this._initRain();
    },
    _createRainCanvas: function () {
      this.remove();
      ...
      rainDiv.setAttribute("class", "rainContainer");
      rainDiv.style = 'pointer-events: none;position: absolute;top:0px;z-index: 200;left: 0px;background-color: rgba(0, 0, 0, 0.125);';
    ...
    _createSnowContainer: function () {
      ...
      this.snowContainer.setAttribute("class", "snowContainer");
      this.snowContainer.style = 'top: 0px;left: 0px;width: 100%;top:0px;height: 100%;pointer-events: none;z-index: 120;position: absolute;background-color: #9d9d9d;background-color: rgba(0, 0, 0, 0.15);'
    },
    _initRain: function () {
      this._createRainTrough();
      this._createRain();
      window.addEventListener("resize", lang.hitch(this, this._createRainTrough));
    },
    // 第一个参数,粒子的数目,用来表示粒子密度;第二个参数,粒子的大小
    _createSnowParticles: function (particleNum, scale4particle) {
      ...
      var particleImage = new Image();
      particleImage.src = this.particleImageSrc;
      ...
      for (var i = 0; i < particleNum; i++) {
        ...
        this.particle.scale.x = this.particle.scale.y = scale4particle;
        this.scene.add(this.particle);
        this.particles.push(this.particle);
      }
      this.snowContainer.appendChild(this.renderer.domElement);
      this.view.container.appendChild(this.snowContainer);
      ...
      this.snowTimer = setInterval(lang.hitch(this, this._animSnowLoop), 1000 / 40);
    },
    _animRainloop: function () {
      switch (this.realTimeWeather) {
        case "小雨":
          var speedRainTrough = 7;
          this._animateRainTrough(speedRainTrough);
          break;
        case "中雨":
          this._animateRain();
          break;
        case "大雨":
          ...
          this._animateRainTrough(speedRainTrough); // 细粒度的雨 - 直线雨
          this._animateRain(); // 粗粒度的雨 - 雨滴,有形状
          break;
        case "强雷阵雨":
          var speedRainTrough = 25;
          this._animateRainTrough(speedRainTrough); // 细粒度的雨 - 直线雨
          this._animateRain(); // 粗粒度的雨 - 雨滴,有形状
          this._animateLightning(); // 闪电
          break;
        case "雨夹雪":
      ...
      this.rainTimer = requestAnimationFrame(lang.hitch(this, this._animRainloop));
    },
    _animSnowLoop: function () {
    ...
    // speedRainTrough 直线雨速度
    _animateRainTrough: function (speedRainTrough) {
      this._clearCanvas1();
      for (var i = 0; i < this.rainthroughnum; i++) {
        if (this.RainTrough[i].y >= this.h) {
          ...
          this.RainTrough[i].y += speedRainTrough;
        }
        this._drawRainTrough(i);
      }
    },
    _animateRain: function () {
      this._clearCanvas2();
      for (var i = 0; i < this.rainnum; i++) {
