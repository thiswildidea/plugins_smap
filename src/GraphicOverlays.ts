...
export default class GraphicOverlays extends EventEmitter {
    ...
    public async add<T extends any[] = any[]>(overlayers: Overlayerbase | Overlayerbase[] | OverlayGroup): Promise<T> {
        // tslint:disable-next-line:variable-name
        const [Graphic, Point, GraphicsLayer, PictureMarkerSymbol,
             // tslint:disable-next-line:variable-name
             ArcGISPolyline, ArcGISPolygon, esriCircle] = await load(['esri/Graphic', 'esri/geometry/Point',
    ...
    public async update<T extends any[] = any[]>(overlayers: Overlayerbase | Overlayerbase[] | OverlayGroup):
    Promise<T> {
        // tslint:disable-next-line:variable-name
        const [Graphic, Point, GraphicsLayer, PictureMarkerSymbol,
            // tslint:disable-next-line:variable-name
