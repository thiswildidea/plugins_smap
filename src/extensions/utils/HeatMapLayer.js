define(["dojo/_base/declare", "dojo/_base/lang", "esri/geometry/Point", "esri/geometry/SpatialReference"],
    function (declare, lang, Point, SpatialReference) {
        return declare("HeatMapLayer", null, {
            ...
            id:null,
             //add h337 By Chrli
            constructor: function (view,config,data,h337,id) {
                this.init(view, config, data, h337, id);

            },
            init: function (view, config, data, h337, id) {
            ...
            freshenLayerData:function (newData) {
                let data = this.convertHeatmapData(newData)
